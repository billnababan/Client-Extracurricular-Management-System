...
const Riwayat = () => {
  ...
  const getData = async () => {
    try {
      const response = await axios.get(`${import.meta.env.VITE_API_URL}/riwayatPendaftaran`);
    ...
    <>
      <Sidebar>
        <div className="w-full h-full font-bold bg-primary p-10">
          <h1 className="text-2xl text-black font-extrabold mt-10 -mb-7">Riwayat Pendaftaran Ekskul {username}</h1>
          <div className="overflow-x-auto mt-10">
            <table className="table text-center rounded-lg overflow-hidden">
              <thead className="rounded-t-lg overflow-hidden">
                <tr className=" text-white bg-cyan-500">
