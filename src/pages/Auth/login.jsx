...
const Login = ({ togglePage }) => {
  ...
  return (
    <>
      <div className="w-full max-w-md p-52 bg-cyan-500 flex flex-col items-center mx-auto my-auto">
        <h2 className="text-2xl font-extrabold tracking-wide  text-white ">Login</h2>
        <form autoComplete="off" onSubmit={handleSubmit(onSubmit)} className="flex flex-col px-10 mt-5 text-black gap-4 w-[450px] ">
          ...
          <p className="mt-4 text-white cursor-pointer text-center" onClick={togglePage}>
